...
<?php 
	...
	class product
	{
		...
		public function Show_Product(){
			$query = "SELECT A.productId, A.productName,A.image, C.brandName,B.catName,A.size,A.price,A.type,A.description FROM tbl_product A, tbl_category B, tbl_brand C WHERE A.catId=B.catId AND A.brandId=C.brandId ORDER BY A.productName DESC";
